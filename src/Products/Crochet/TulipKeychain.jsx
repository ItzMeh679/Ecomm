...
const TulipKeychainPage = ({ onBack, product }) => {
  ...
  const handleAddToCart = () => {
    ...
    alert(`Added ${quantity} Tulip Keychain(s) to cart successfully!`);
  };

  const handleBuyNow = () => {
    alert(`Proceeding to checkout with ${quantity} Tulip Keychain(s)`);
  };
