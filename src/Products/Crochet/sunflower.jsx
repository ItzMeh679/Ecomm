...
const SunflowerPage = ({ onBack, onNavigate, product }) => {
  ...
  const handleAddToCart = () => {
    ...
    const cartProduct = {
      ...
      image: '/src/Products/Crochet/Images/sunflower.png',
      tags: ['Sunflower', 'Floral', 'Handmade', 'Cotton', 'Decor'],
      rating: 4.8,
      reviews: 96,
    ...
    setTimeout(() => {
      ...
      alert(`Successfully added ${quantity} Sunflower Crochet${quantity > 1 ? 's' : ''} to cart!`);
    }, 500);
  };
  ...
  const handleBuyNow = () => {
    ...
    if (onNavigate) {
      ...
      alert(`Added ${quantity} Sunflower Crochet${quantity > 1 ? 's' : ''} to cart! Please go to cart to checkout.`);
    }
  };
  ...
  const styles = {
    ...
    imageContainer: {
      ...
      borderRadius: '20px',
      overflow: 'hidden',
      background: 'linear-gradient(135deg, rgba(245, 158, 11, 0.1), rgba(146, 64, 14, 0.05))',
      cursor: 'zoom-in',
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.breadcrumb}>
        <span>Home</span> / <span>Crochet</span> / <span style={{ color: '#f59e0b', fontWeight: '600' }}>Sunflower Crochet</span>
      </div>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.leftSection}>
          ...
          >
            <img 
              src="/src/Products/Crochet/Images/sunflower.png" 
          ...
          <div style={styles.dimensions}>
            ...
            <p style={styles.dimensionText}><strong>Height:</strong> 35cm</p>
            <p style={styles.dimensionText}><strong>Flower Diameter:</strong> 15cm</p>
            <p style={styles.dimensionText}><strong>Stem Width:</strong> 8cm</p>
          ...
          <div style={styles.productDescription}>
            ...
            <ul style={styles.featureList}>
              {[
                ...
                'Stunning sunflower design with realistic center',
                'Vibrant golden petals with intricate detailing',
                'Sturdy green stem with natural texture',
                'Large size perfect as statement decor piece',
        ...
        <div style={styles.rightSection}>
          <div style={styles.productHeader}>
            <h1 style={styles.productTitle}>Sunflower Crochet</h1>
            <div style={styles.rating}>
              <span style={styles.stars}>★★★★★</span>
              <span style={styles.reviewCount}>(96 reviews)</span>
            </div>
          </div>

          <div style={styles.pricing}>
            <span style={styles.currentPrice}>₹449</span>
            <span style={styles.originalPrice}>₹549</span>
            <span style={styles.discountBadge}>18% OFF</span>
          </div>
          ...
          <div style={styles.overview}>
            ...
            <p style={styles.overviewText}>
              Brighten your space with this magnificent hand-crocheted sunflower! This stunning piece 
              captures the joy and warmth of a real sunflower with its vibrant golden petals and detailed 
              center. Standing tall at 35cm, it makes a perfect statement piece for any room. The intricate 
              craftsmanship showcases realistic textures and colors that bring the beauty of nature indoors 
          ...
          <div style={styles.actionButtons}>
            ...
            <button 
              ...
              onMouseEnter={(e) => {
                if (!isAddingToCart) {
                  e.target.style.transform = 'translateY(-2px)';
                  e.target.style.boxShadow = '0 10px 32px rgba(217, 119, 6, 0.4)';
                }
              }}
              onMouseLeave={(e) => {
                if (!isAddingToCart) {
          ...
          <div style={styles.additionalInfo}>
            {[
              ...
              { icon: '🌻', text: 'Symbol of happiness and positivity' }
            ].map((info, index) => (
